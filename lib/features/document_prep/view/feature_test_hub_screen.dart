    ...
    return AppScaffold(
      ...
      body: ListView(
        ...
        children: const [
          ...
          _FeatureButton(title: 'Compress PDF', path: '/hub/pdf-compression'),
          _FeatureButton(title: 'Change Image Type', path: '/hub/image-format'),
          _FeatureButton(title: 'PDF Security', path: '/hub/pdf-security'),
        ],
      ),
    );
  }
