...
// This annotation tells mockito to generate a mock class for
// LocalAuthentication.
...
void main() {
  ...
  group('AuthService', () {
    test(
      ...
      () async {
        // Arrange: Tell the mock what to return when
        // isDeviceSupported is called.
    ...
    test('authenticate returns true when plugin call is successful', () async {
      // Arrange: Configure the mock to return true for a
    ...
    test(
      'authenticate returns false when plugin call is unsuccessful',
      () async {
        // Arrange: Configure the mock to return false for a
