...
void main() {
  ...
  group('EncryptionService Tests', () {
    ...
    test('should encrypt and decrypt data successfully (round-trip test)', () {
      ...
      final Uint8List encryptedBase64 = encryptionService.encrypt(originalData);
      final Uint8List decryptedData = encryptionService.decrypt(
        encryptedBase64,
      );
